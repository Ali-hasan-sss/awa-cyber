...
interface AddFourthSectionFormProps {
  serviceId: string;
  section?: any | null;
  onSuccess: () => void;
  onCancel: () => void;
...
export default function AddFourthSectionForm({
  serviceId,
  section,
  onSuccess,
  onCancel,
}: AddFourthSectionFormProps) {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-blue-900/30 border border-blue-700 rounded-lg p-4">
          <p className="text-sm text-blue-200">
            {isArabic
              ? "ملاحظة: البطاقات أدناه سيتم جلبها تلقائياً من الأعمال المرتبطة بهذه الخدمة."
              : "Note: The project cards below will be automatically fetched from portfolios related to this service."}
          </p>
        </div>
