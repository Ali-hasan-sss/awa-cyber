    ...
    <>
      ...
      <section className="relative min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-white overflow-hidden pt-28 pb-16">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-lg mx-auto bg-black/60 border border-white/10 rounded-[2rem] p-8 md:p-10 shadow-2xl space-y-8">
            <div className="text-center space-y-3">
              <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-primary">
              ...
              <div className="space-y-3">
                <label className="text-sm text-white/80 space-y-2 block">
                  ...
                  <Input
                    ...
                    className="h-12 rounded-2xl border border-white/10 bg-white/5 text-sm text-white placeholder:text-white/40 focus-visible:ring-0 focus:border-primary"
                    value={form.email}
                    onChange={(event) =>
